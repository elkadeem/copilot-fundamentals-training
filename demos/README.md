...
- **[Copilot Features](copilot-features/)** - Enterprise-grade bulk rename demo. Complete codebase transformation from "chroma_" to "chroma_" using Copilot Agent, PR summaries, and automated testing workflows.
